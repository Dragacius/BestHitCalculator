...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "Owned Total = " << owned << endl;
            ...
            cout << "total Stats line 163 Total = " << owned << equipStat1 << equipStat2 << auraLevel << playerLevel << totalStats << endl;
            totalStats = totalStats * drillMaster;
            auraPerc = auraPerc / 100;
            endBoost = endBoost / 100;
            cout << "auraPerc line 166 is = " << auraPerc << endl;
            double extraPerc = totalStats * auraPerc + totalStats;
            cout << "total Stats line 168 Total = " << extraPerc << endl;
            double primPerc = swordLevel * auraPerc + swordLevel;
            std::cout << "sword level line 170 Total = " << setprecision(10) << primPerc << endl;
            double totalAtk = extraPerc + primPerc;
            std::cout << "total Stats line 172 Total = " << setprecision(10) << totalAtk << endl;
